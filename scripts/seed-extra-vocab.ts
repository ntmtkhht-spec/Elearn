...
const DECKS = [
  ...
  // C2
  {
    ...
    cards: [
      ...
      { word: 'Ontology', translation: 'Ontologie (Seinslehre)', pronunciation: '/ɒnˈtɒlədʒi/', partOfSpeech: 'noun', exampleSentence: 'Ontology is the branch of metaphysics dealing with the nature of being.', exampleTranslation: 'Ontologie ist der Zweig der Metaphysik, der sich mit der Natur des Seins befasst.', difficulty: 5 },
...
async function main() {
  console.log('Seeding extra vocab decks...')
  for (const deck of DECKS) {
    ...
    console.log(`Created deck: ${deck.name} with ${deck.cards.length} cards.`)
  }
  console.log('Finished seeding extra vocab!')
}
